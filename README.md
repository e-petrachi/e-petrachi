...
class DataScientist:
    def __init__(self):
        ...
        self.summary = "Hi I'm " + self.name + " a " + self.role + " with a technical education. I approach my data-driven projects from a business point of view and I use the agile approach to quickly deliver results and improve them iteratively."
